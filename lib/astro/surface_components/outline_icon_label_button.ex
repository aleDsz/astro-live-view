defmodule Astro.SurfaceComponents.OutlineIconLabelButton do
  @moduledoc """
  Astro outline iconlabel button.

  For more information, see Storybook: https://astro.magnetis.com.br/buttons#outline-iconlabel-buttons
  """
